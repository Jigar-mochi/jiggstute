        ...
        <>
            <div className={`container text-${props.mode === "light" ? "dark" : "light"}`}>
                <div>
                    ...
                    <div className="mb-3">
                        <textarea className="form-control" style={{ color: props.mode === "dark" ? "white" : "black", backgroundColor: props.mode === "dark" ? "#7370ff" : "white" }} value={text} onChange={handelonchange} placeholder="Leave a comment here" id="mytextbox" rows="8"></textarea>
                    </div>
